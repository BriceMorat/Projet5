<?php $title = 'Gallerie photos de '.$member['pseudo'].''; ?>
...
<section id="container" class="jumbotron container border border-dark position-relative"> 
	<div class="text-center">
		<?= '<h3>Gallerie photos de '.$member['pseudo'].'<br/><em class="h6 text-info">membre depuis le '.$member['reg_date'].' </em></h3>' ?>
	</div><br/>
		      	...
		      	<figure class="col-md-4">
		        	...
		        	<img class="img-fluid" src="public/upload_img/<?= $userPostImage['file_name']; ?>" alt="image">
		      		...
		      		<figcaption class="text-center text-white font-weight-bold">
		    			<p class="mb-1 h5"><?= $userPostImage['country'].', <em class="h6">'.$userPostImage['city'] ?></em></p>
		  			</figcaption>
		      	</figure>
